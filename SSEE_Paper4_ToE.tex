...
The physical baryon density $\Omega_b h^2 = 0.02260$ derived in
...
\begin{equation}
\boxed{Y_p^{\rm SSEE} = 0.2471 + 0.96\times(0.02260-0.02237) = 0.2473.}
\label{eq:yp}
\end{equation}
Observed values: $Y_p = 0.2471\pm0.0003$ (Planck CMB, $+0.7\sigma$);
...
$Y_p$               & 0.2473 & $0.2471\pm0.0003$   & $0.7\sigma$ & BBN (no fit) \\
...
\begin{itemize}
  ...
  \item $Y_p = 0.2473$ ($0.7\sigma$ from Planck CMB, $0.6\sigma$ from HII — no fit)

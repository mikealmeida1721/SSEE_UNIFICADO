...
const _CONSTANTS = {
  ...
  AURA:     { value: AURA,     description: "Contenedor / Límite" },
  MIRA:     { value: MIRA,     description: "Frecuencia de Observación" },
  DUAL:     { value: DUAL,     description: "Dualidad" },
  TRIAL:    { value: TRIAL,    description: "Materia / Límite 3D" },
